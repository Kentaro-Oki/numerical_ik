...
class Jacobian():
    ...
    def jacob_pvrm(self, theta, fk_pvrm):
    ...
    def jacob_pv(self, theta, fk_pvrm):
        self._l_theta = len(theta)
    ...
    def jacob_pvs(self, theta, fk_pvs):
        self._l_theta = len(theta)
    ...
    def arm(self, theta):
        return self.jacob_pvrm(theta, self.fk.fk_arm_right_pvrm)

    def elbow(self, theta):
        return self.jacob_pv(theta, self.fk.fk_elbow_right_pvrm)

    def wrist(self, theta):
        return self.jacob_pv(theta, self.fk.fk_wrist_right_pvrm)

    def elbow_wrist(self, theta):
        return self.jacob_pvs(theta, self.fk.fk_elbow_wrist_right_pvs)

    def finger_tips(self, theta):
        return self.jacob_pvs(theta, self.fk.fk_fingers_right_pvs)